...
def test_faithful_machine(task_name):
    ...
    adapter_path = "./07_Finetune/qwen_0_5b_faithful_results/final_lora_adapter"
    ...
    # Load LISP specification for the task (Spiral Matrix II)
    lisp_path = f"01_TestDefinitions/{task_name}/problem.nl" # We'll generate LISP or use a known good one
    # For this test, let's use the actual LISP that 14B struggled with
