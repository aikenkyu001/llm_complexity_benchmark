...
ADAPTER_PATH="./07_Finetune/qwen_1_5b_finetune_results/final_lora_adapter"
OUTPUT_DIR="04_RawData/qwen2_5-1.5b-expert"
REPORT_FILE="05_Reports/1.5B_BENCHMARK_RESULTS.md"

echo "=========================================================="
echo " Starting Full Benchmark for Qwen 2.5-Coder-1.5B-Expert"
echo "=========================================================="
...
echo "# Benchmark Results: Qwen 2.5-Coder-1.5B-Expert" > $REPORT_FILE
